        ...
        <Wrapper className="">
            <div className='flex flex-col items-center h-screen'>
                ...
                <div className='flex flex-col items-center gap-20 mx-3 lg:mx-6 lg:flex-row h-5/6 gap-y-8'>
                    ...
                    <div className='flex flex-col items-center sm:mt-9 gap-y-6 justify-center text-center text-[0.7rem] sm:text-[1rem] sm:mx-6 sm:gap-7 md:text-[1.2rem] md:mx-8 lg:w-1/2 lg:text-[1rem] xl:text-[1rem]'>
