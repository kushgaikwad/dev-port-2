...
const About = (props: Props) => {
    return (
        <div className='flex flex-col items-center h-screen'>
            ...
            <div className='flex flex-col items-center mx-3 lg:mx-6 lg:flex-row h-5/6 gap-y-8 gap-7'>
                <div className='relative w-3/4 h-1/2 rounded-xls lg:h-3/4 lg:w-1/2'>
                    < Image src='/images/musket-headshot.jpg' alt="test" layout="fill" objectFit="cover" className='rounded-3xl' />
                </div>
                <div className='flex flex-col items-center  gap-y-6 justify-center text-center text-[0.7rem] sm:text-[1rem] sm:mx-6 sm:gap-7 md:text-[1.2rem] md:mx-8 lg:w-1/2 lg:text-[1rem] xl:text-[1rem]'>
